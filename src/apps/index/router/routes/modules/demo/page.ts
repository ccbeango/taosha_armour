...
const ExceptionPage = () => import('@index/views/sys/exception/Exception.vue')
      ...
      children: [
        {
          ...
          name: 'FormBasicPage',
          component: () =>
            import('@index/views/demo/page/form/basic/index.vue'),
          meta: {
        ...
        },
        {
          path: 'step',
          name: 'FormStepPage',
          component: () => import('@index/views/demo/page/form/step/index.vue'),
          meta: {
        ...
        },
        {
          path: 'high',
          name: 'FormHightPage',
          component: () => import('@index/views/demo/page/form/high/index.vue'),
          meta: {
      ...
      children: [
        {
          ...
          name: 'DescBasicPage',
          component: () =>
            import('@index/views/demo/page/desc/basic/index.vue'),
          meta: {
        ...
        },
        {
          path: 'high',
          name: 'DescHighPage',
          component: () => import('@index/views/demo/page/desc/high/index.vue'),
          meta: {
      ...
      children: [
        {
          ...
          component: () =>
            import('@index/views/demo/page/result/success/index.vue'),
          meta: {
        ...
        },
        {
          ...
          name: 'ResultFailPage',
          component: () =>
            import('@index/views/demo/page/result/fail/index.vue'),
          meta: {
      ...
      children: [
        {
          ...
          component: () =>
            import('@index/views/demo/page/account/center/index.vue'),
          meta: {
        ...
        },
        {
          ...
          component: () =>
            import('@index/views/demo/page/account/setting/index.vue'),
          meta: {
      ...
      children: [
        {
          ...
          name: 'ListBasicPage',
          component: () =>
            import('@index/views/demo/page/list/basic/index.vue'),
          meta: {
        ...
        },
        {
          path: 'card',
          name: 'ListCardPage',
          component: () => import('@index/views/demo/page/list/card/index.vue'),
          meta: {
        ...
        },
        {
          ...
          name: 'ListSearchPage',
          component: () =>
            import('@index/views/demo/page/list/search/index.vue'),
          meta: {
